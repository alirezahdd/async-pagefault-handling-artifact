...
batching=("")      #("" "1")  batch pagefaults(1) or not(0)
batching_mode=("") #(" " "1" "2")  use process_madvise(1) or madvise(2)
queue_sizes=("") #(" " "8" "16" "64" "512" "1024") page fault queue size. Max supported size is 1024.
