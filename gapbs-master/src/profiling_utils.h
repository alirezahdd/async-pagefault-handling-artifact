...
void stop_taskstats(){
  ...
  if (f) {
        fprintf(f,
          "cpu_run_real_total: %llu\n"
          "User_Time: %llu\n"
          "System_Time: %llu\n"
          "Block_IO_Time: %u\n"
          "Scaled_User_Time: %llu\n"
          "Scaled_System_Time: %llu\n"
          "Scaled_Run_Time: %llu\n"
          "Read_Char: %llu\n"
          "Write_Char: %llu\n"
          "Read_Syscalls: %llu\n"
          ...
          "Thrashing_Delay: %llu\n"
          "IRQ_Delay: %llu\n",
          ts_end.cpu_run_real_total - ts_start.cpu_run_real_total,
          ts_end.ac_utime - ts_start.ac_utime,
          ts_end.ac_stime - ts_start.ac_stime,
          ts_end.ac_btime - ts_start.ac_btime,
          ts_end.ac_utimescaled - ts_start.ac_utimescaled,
          ts_end.ac_stimescaled - ts_start.ac_stimescaled,
          ts_end.cpu_scaled_run_real_total - ts_start.cpu_scaled_run_real_total,
          ts_end.read_char - ts_start.read_char,
          ts_end.write_char - ts_start.write_char,
          ts_end.read_syscalls - ts_start.read_syscalls,
          ts_end.write_syscalls - ts_start.write_syscalls,
          ts_end.read_bytes - ts_start.read_bytes,
          ts_end.write_bytes - ts_start.write_bytes,
          ts_end.cancelled_write_bytes - ts_start.cancelled_write_bytes,
          ts_end.ac_majflt - ts_start.ac_majflt,
          ts_end.ac_minflt - ts_start.ac_minflt,
