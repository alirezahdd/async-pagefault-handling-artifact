...
kernels=("bc_batching" "bfs_batching" "cc_batching" "pr_batching" "sssp_batching" "tc_batching") #("bc" "bfs" "cc" "pr" "sssp" "tc") #("bc_batching" "bfs_batching" "cc_batching" "pr_batching" "sssp_batching" "tc_batching")
...
NUM_SWAP_PARTITIONS=1                 #can be 1, 2, 3, or 4 in our system (terra)
NUM_CORES=$(lscpu | grep -w "CPU(s):" | grep -v "NUMA" | awk '{print $2}') #16
